...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!isset($_SESSION['name']) && isset($_POST['name'])) {
        ...
        if (in_array($name, $_SESSION['usernames'])) {
    ...
    if (isset($_POST['msg'])) {
        $sanitizedMessage = censorMessage($_POST['msg'], $forbiddenWords);
...
<body>
 <script>
    ...
    <h2 style="color:white; font-family: sans-serif; text-align:center;"><a style="color:blue;">Blue</a>Users</h2>
